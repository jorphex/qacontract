...
@click.option(
    "--max-amount",
    envvar="PUZZLEGIVEAWAY_MAX_AMOUNT",
    required=True,
    type=int,
...
@click.option(
    "--floor-amount",
    envvar="PUZZLEGIVEAWAY_FLOOR_AMOUNT",
    required=True,
    type=int,
...
@click.option(
    "--deadline",
    envvar="PUZZLEGIVEAWAY_DEADLINE",
    required=True,
    type=int,
...
@click.option(
    "--cliff-seconds",
    envvar="PUZZLEGIVEAWAY_CLIFF_SECONDS",
    default=0,
    show_default=True,
    type=int,
...
@click.option(
    "--answer-hash",
    envvar="PUZZLEGIVEAWAY_ANSWER_HASH",
    required=True,
...
def cli(
    ...
    click.echo(f"puzzle_giveaway={contract.address}")
